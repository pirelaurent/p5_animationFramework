...
### sample 
It is better to create scenarios, scripts and journeys in the setup of p5 to be sure everything is well initialized.    
For code readibility, this is done in separated functions:    
```javascript 
function setup() {
